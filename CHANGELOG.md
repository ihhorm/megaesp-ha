...
### Home Assistant `2026.8.11`

- Додано підтримку нових портів `TX` (`GPIO1`) і `RX` (`GPIO3`) в інтеграції Home Assistant.
- На панелі `MegaESP` і в сутностях тепер використовуються підписи `TX`/`RX`, а не `P10`/`P11`.
- Додано сумісність із новою прошивкою `11.5`.
